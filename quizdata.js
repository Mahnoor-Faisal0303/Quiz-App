const Questions = [
    {
      ...
      answers: [
        ...
        { text: "Let", correct: false, id: 'b' },
        { text: "Const", correct: false, id: 'c' },
        { text: "All of the above", correct: true, id: 'd' },
      ],
    },
    {
      id: 2,
      ...
      answers: [
        ...
        { text: "Data Object Mode", correct: false, id: 'f' },
        { text: "Document Order Module", correct: false, id: 'g' },
        { text: "Dynamic Output Mechanism", correct: false, id: 'h' },
      ],
    },
    {
      id: 3,
